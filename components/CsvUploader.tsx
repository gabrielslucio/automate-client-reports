...
export function CsvUploader({onDataLoaded} : CsvUploaderProps) {
    ...
    return (
        <div className="rounded-2x1 border border-dashed border-slate-300 bg-white p-8 text-center shadow-sm">
            ...
            <label className="my-6 inline-flex cursor-pointer rounded-xl bg-slate-900 px-5 py-3 text-sm font-medium text-white hover:bg-slate-700">
                Escolher ficheiro
                <input
                    type="file"
                    accept=".csv"
